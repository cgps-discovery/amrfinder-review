...
if __name__ == "__main__":
    ...
    parser.add_argument('--existing', help='STDIN is an existing amrfinder output table', action='store_true', required=False) 
    parser.add_argument('--tempdir', help='Change tempdir default is /opt/amrfinder/', type=str, default='/opt/amrfinder/') 
