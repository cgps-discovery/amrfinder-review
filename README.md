...
docker run --platform linux/amd64 -e SPACES_KEY='DO00XUXLKE84B3TEKB7K' -e SPACES_SECRET='dvM813ccVCz4cetddhau1eWeeeEHrmy9APGdMJkyo0E' docker.io/juliofdiaz/amrfinder:beta --fasta_s3_path https://pathogenwatch-cgps.ams3.digitaloceanspaces.com/pw-live/fasta/70/701745104cd7497d8eabc4389ea412bbecb2bc59.fa.gz --output_s3_path https://cgps.ams3.digitaloceanspaces.com/discovery/analysis/amrfinder/1.0.0/ --working_dir /tmp --verbose --debug --tax_id 470
```
